        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                HStack(spacing: 14) {
                    ...
                    .buttonStyle(Scene7ButtonStyle(color: .scene7Accent, disabled: !viewModel.canExport))
    ...
    var recordBindings: [Binding<Scene7ImageRecord>] {
        ...
        if showOnlyExists && checked {
            source = viewModel.records.filter {
                ...
                || $0.renameError != nil
                || $0.proposedName != $0.filename // <---- This is the key addition!
            }
        } else {
            ...
            HStack {
                TextField("Rename", text: $record.proposedName)
                    ...
                    .onChange(of: record.proposedName) { newValue in
                        ...
                        let validated = viewModel.validateRename(record, existingNames: otherNames)
                        record.renameError = validated.renameError
